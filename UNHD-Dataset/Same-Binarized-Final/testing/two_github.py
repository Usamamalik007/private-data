...
while aa<5:
    ...
    cv2.imwrite("private-data/UNHD-Dataset/Same-Binarized-Final/testing/"+"_"+str(y)+"_"+str(z)+'.png', vis)
    with open("private-data/UNHD-Dataset/Same-Binarized-Final/testing/"+"_"+str(y)+"_"+str(z)+'.gt.txt', 'w',encoding="utf-8") as f:
