...
while aa<5:
    ...
    cv2.imwrite("private-data/UNHD-Dataset/Same-Binarized-Final/testing/"+"_"+str(x)+"_"+str(y)+"_"+str(z)+"_"+str(w)+'.png', vis)
    with open("private-data/UNHD-Dataset/Same-Binarized-Final/testing/"+"_"+str(x)+"_"+str(y)+"_"+str(z)+"_"+str(w)+'.gt.txt', 'w',encoding="utf-8") as f:
